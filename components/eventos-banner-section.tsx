    ...
    <section className="py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal>
          <a
            href="/eventos"
            className="group relative block overflow-hidden rounded-3xl bg-foreground shadow-2xl transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_25px_70px_-15px_var(--brand)]"
          >
            ...
            <div className="flex justify-center py-5">
              <PromoCountdown targetMs={targetMs} variant="evento" />
            </div>
          </a>
        </Reveal>
      </div>
